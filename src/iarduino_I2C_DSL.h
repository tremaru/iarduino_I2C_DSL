...
#endif																																	//
																																		//
#include		<iarduino_I2C_DSL_I2C.h>																								//	Подключаем файл iarduino_I2C_DSL.h - для работы с шиной I2C		(используя функции структуры iI2C)
																																		//
...
const	uint32_t			tmrPeriodFLG			=	10;																				//	Определяем константу  для хранения минимального времени между опросом регистра флагов «REG_DSL_FLG».
