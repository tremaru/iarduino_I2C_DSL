...
void setup(){                                     //
    ...
    if( dsl.begin(&Wire) ){                       //   Инициируем работу с датчиком освещённости, указав ссылку на объект для работы с шиной I2C на которой находится датчик (Wire, Wire1, Wire2 ...).
